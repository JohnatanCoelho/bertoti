...
Comentário: 
Ao decorrer do texto percebemos a diferença entre profissionais de TI e engenheiros de software, cada termo tem um foco e implicações diferentes, as pessoas que estudam TI tendem trabalhar em empregos escrevendo código, ou seja, programadores. Engenheiro de software, tem um ar mais sério, pois existe uma perspectiva de aplicação e implicação de conhecimento para a construção de algo sério
